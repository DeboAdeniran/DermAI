...
import { X, Menu, ArrowLeft, UserPlus, Eye, EyeOff } from "lucide-react";
...
export function LoginPage() {
  ...
  // Handle OAuth redirect with token in URL query params
  useEffect(() => {
            ...
            <div className="flex justify-between items-center h-14 px-4 sm:px-6">
              ...
              <div className="hidden sm:flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 bg-[#8b7355] text-white rounded-full hover:bg-[#6d5a43] hover:shadow-lg transition-all font-light text-sm"
                >
                  Sign Up
                </button>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-4 h-4 rounded border-[#e8e6e3] text-[#8b7355] focus:ring-[#8b7355]"
                  />
                  <label
                    htmlFor="remember"
